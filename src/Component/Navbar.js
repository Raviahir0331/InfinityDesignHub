...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className=" p-4 relative" style={{ backgroundImage: 'url("https://wgl-dsites.net/bili/light/wp-content/uploads/2023/03/homepage-1_1.jpg")' }}>
        <div className="container mx-auto flex justify-between items-center source-code-pro">
          ...
          <div className="text-white font-bold text-xl" data-aos="fade-right">
            <Link to="/">
              <img
                src="https://wgl-dsites.net/bili/wp-content/uploads/2022/03/logo-1.png"
                className="h-12"
              />
            </Link>
          </div>
        ...
        >
          ...
          <div className="dropdown">
            <Link
              className="nav-link dropdown-toggle text-white no-underline"
              to="/"
              role="button"
            >
              Home
